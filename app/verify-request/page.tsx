        ...
        <Card className="w-full max-w-xl rounded-[34px] border-[rgba(111,82,95,0.14)] bg-white/88 shadow-float">
          <CardContent className="grid gap-6 p-6 sm:p-8">
            ...
            <div className="grid gap-3">
              <p className="font-marker text-3xl text-petal-700">tiny inbox quest</p>
              <h1 className="font-body text-4xl font-semibold leading-none tracking-[-0.04em] sm:text-6xl">check your email for the magic link.</h1>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="secondary" className="normal-case">one-time link</Badge>
              <Badge variant="secondary" className="normal-case">expires fast</Badge>
              <Badge variant="secondary" className="normal-case">no password needed</Badge>
            </div>
