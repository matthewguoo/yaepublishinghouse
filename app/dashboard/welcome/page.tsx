        ...
        <Card className="w-full max-w-xl rounded-[34px] border-petal-200/70 bg-white/84 shadow-float">
          <CardContent className="grid gap-5 p-6 sm:p-8">
            ...
            <div className="grid gap-3">
              <h1 className="font-display text-4xl leading-none tracking-[-0.05em] sm:text-6xl">Add Postgres first.</h1>
              <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                This part needs Vercel Postgres hooked up before a handle can actually be claimed.
              </p>
              <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                Once the env vars are in place, come back here and it should work.
              </p>
            </div>
        ...
        <Card className="w-full max-w-2xl rounded-[34px] border-petal-200/70 bg-white/84 shadow-float">
          <CardContent className="grid gap-8 p-6 sm:p-8">
            <div className="grid gap-4">
              ...
              <div className="grid gap-3">
                <p className="font-scribble text-2xl text-petal-700">almost there</p>
                <h1 className="font-display text-4xl leading-none tracking-[-0.05em] sm:text-6xl">Claim your @handle.</h1>
                <p className="text-sm leading-7 text-muted-foreground sm:text-base">
